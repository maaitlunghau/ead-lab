...
IF DB_ID(N'EAD_Practice02') IS NULL
BEGIN
    CREATE DATABASE EAD_Practice02;
END;
GO
...
VALUES
    ('admin',  '123456', 'admin', 'admin.jpg'),
    ('john',   '123456', 'user',  'john.jpg'),
    ('mary',   '123456', 'user',  'mary.jpg'),
    ('peter',  '123456', 'user',  'peter.jpg'),
    ('sarah',  '123456', 'user',  'sarah.jpg');
GO
